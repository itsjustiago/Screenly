...
// Shared visual language, ported from Facet/Clippy/Sleepy so Screenly's menu-bar
// panel and Settings read as part of the same family. Brand colour is Screenly's teal.
